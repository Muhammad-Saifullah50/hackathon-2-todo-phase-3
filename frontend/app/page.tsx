...
export const metadata: Metadata = {
  ...
  description:
    "Transform your productivity with TodoMore's beautiful, intuitive task manager. Features include due dates, tags, subtasks, recurring tasks, kanban boards, and more. Free forever plan available.",
  keywords: [
    "task management",
    "todo list",
    "productivity",
  ...
  openGraph: {
    title: "TodoMore - Beautiful Task Management for Everyone",
    description:
      "Transform your productivity with TodoMore's beautiful, intuitive task manager. Free forever plan available.",
    url: "/",
    siteName: "TodoMore",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TodoMore - Task Management Dashboard",
      },
    ],
    locale: "en_US",
    type: "website",
